...
var NewExpenseModal = React.createClass({
  ...
  handleClose: function (e) {
    if (_.isFunction(this.props.callback_onclose)) {
      this.props.callback_onclose('expense');
    }
  },
      ...
      <div>
        <Modal 
          ...
          <div className='modal-body'>
            ...
            <Input type='text' ref='account' addonBefore='Account' placeholder='Cash on hand' />
            <Input type='text' ref='note' addonBefore='Note' placeholder='Grocery Store' />
          </div>
          <div className='modal-footer'>
            <Button onClick={this.handleClose} >Close</Button>
            <Button onClick={this.handleSave} bsStyle='primary'>Add Expense</Button>
          </div>
        </Modal>
